...
<div class="row">
      ...
      <form action="/action_page.php">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="email" name="email" placeholder="order@example.com">
            <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="Full Address">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="400102">
              </div>
            </div>
          </div>
  ...
  <div class="col-25">
    <div class="container">
      ...
      <!-- <p><a href="#">Product 1</a> <span class="price">₹150</span></p>
      ...
      <hr>
      <p>Total <span class="price" style="color:black"><b><?php echo "$totalprice1"; ?></b></span></p>
    </div>
  </div>
</div>
